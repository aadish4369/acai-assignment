...
const defaultHolidayCalendar = "https://www.officeholidays.com/ics/spain/catalonia"
...
func (HolidaysTool) Execute(ctx context.Context, args json.RawMessage) (string, error) {
	link := defaultHolidayCalendar
	...
	if err != nil {
		return "", fmt.Errorf("load holiday events: %w", err)
	}

	var payload holidaysArgs
